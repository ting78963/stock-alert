        ...
        *intraday_rows,
        ...
        {"type": "box", "layout": "horizontal", "margin": "md", "contents": [
            {"type": "text", "text": "P1", "size": "sm", "weight": "bold",
             "color": C_TEXT, "flex": 0},
            {"type": "text", "text": "676萬+筆  →  4,293組訊號", "size": "xs",
             "color": C_TEXT, "align": "end", "flex": 1},
        ]},
        {"type": "box", "layout": "horizontal", "margin": "sm", "contents": [
            {"type": "text", "text": "ABC", "size": "sm", "weight": "bold",
             "color": C_TEXT, "flex": 0},
            {"type": "text", "text": "664萬+筆・1,282檔  →  741組", "size": "xs",
             "color": C_TEXT, "align": "end", "flex": 1, "wrap": True},
        ]},
        {"type": "text", "text": "A｜+10%　387 / 646 達標　59.9%", "size": "xs",
         "color": C_TEXT, "margin": "md"},
        {"type": "text", "text": "B｜+15%　90 / 162 達標　55.6%", "size": "xs",
         "color": C_TEXT, "margin": "sm"},
        {"type": "text", "text": "C｜+20%　55 / 128 達標　43.0%", "size": "xs",
         "color": C_TEXT, "margin": "sm"},
        {"type": "separator", "color": C_BORDER, "margin": "lg"},
        {"type": "box", "layout": "horizontal", "margin": "md", "contents": [
